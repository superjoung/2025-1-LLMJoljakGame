...
public abstract class BaseNpcStatAction : MonoBehaviour
{
    ...
    public abstract NPCAttachData NpcData { get; set; } // NPC 정보가 담겨있는 스크립트
    public abstract bool IsTalkWithPlayer { get; set; } // NPC가 플레이어와 대화하기 시작했는지
    public abstract float MoveSpeed { get; } // Npc가 이동하는 속도
    public abstract Transform SpotPos { get; set; } // NPC가 이동해야하는 장소
